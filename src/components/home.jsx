        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center max-w-7xl w-full">
          ...
          <div className="space-y-6">
            <div className="space-y-1">
              ...
              <div data-aos="fade-in" data-aos-delay="300">
                <AuroraText className="text-3xl md:text-5xl lg:text-7xl font-bold">
                  TwoSIJA
                </AuroraText>
              </div>
            </div>
            ...
            {/* SUBTITLE */}
            <p
              className="text-neutral-800 text-base md:text-lg max-w-xl"
              data-aos="fade-up"
              data-aos-delay="300"
            >
              2nd Generation of SIJA – Sistem Informasi Jaringan dan Aplikasi
              <br />
              <span className="font-medium">SMK Negeri Kabuh</span>
            </p>
          ...
          >
            <img
              src="/icon-sija.png"
              alt="Logo SIJA"
              className="w-full max-w-sm md:max-w-md lg:max-w-lg aspect-video object-contain"
            />
          </div>
        </div>
      </div>
